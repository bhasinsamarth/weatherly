                ...
                <SafeAreaView>
                    ...
                    <View style={tw`gap-1 mb-2`}>
                        ...
                        <View style={tw`flex-row items-center mx-3 gap-2 mt-5`}>
                            ...
                            <Text style={tw`text-white text-[15px] font-semibold mt-1 `}>{weather.windSpeed}</Text>
                        </View>
                        {/* visibility details */}
                        <View style={tw`flex-row items-center mx-3 gap-2 mt-5`}>
                            <View style={tw`flex-row`}>
                            ...
                            <Text style={tw`text-white text-[15px] font-semibold mt-1`}>{weather.visibility}</Text>
                        </View>
